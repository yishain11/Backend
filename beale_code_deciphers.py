class FirstLetterIterator:
    ...
    def __next__(self):
        if self.index >= len(self.cipher):
            raise StopIteration
        else:
            position = self.cipher[self.index]
            if position <= len(self.text):
                self.index += 1
                return self.text[position - 1][0]
            else:
                self.index += 1
                return ""
...
def main():
    declaration_text = "When, in the course of human events, it becomes necessary for one people to dissolve the political" \
                   ...
                   "let facts be submitted to a candid world. He has refused his assent to laws, the most wholesome and" \
                   ...
                   "when so suspended, he has utterly neglected to attend to them. He has refused to pass other laws " \
                   "for the accommodation of large districts of people, unless those people would relinquish the right " \
                   ...
                   "his measures. He has dissolved representative houses repeatedly, for opposing with manly " \
                   "firmness his invasions on the rights of the people. He has refused for a long time, after such " \
                   "dissolutions, to cause others to be elected; whereby the legislative powers, incapable of " \
                   "annihilation, have returned to the people at large for their exercise; the state remaining in " \
                   ...
                   "and raising the conditions of new appropriations of lands. He has obstructed the administration of " \
                   "justice, by refusing his assent to laws for establishing judiciary powers. He has made judges " \
                   "dependent on his will alone, for the tenure of their offices, and the amount and payment of their " \
                   "salaries. He has erected a multitude of new offices, and sent hither swarms of officers to harass" \
                   " our people, and eat out their substance. He has kept among us, in times of peace, standing armies" \
                   " without the consent of our legislature. He has affected to render the military independent" \
                   " of and superior to civil power. He has combined with others to subject us to a jurisdiction " \
                   "foreign to our constitution, and unacknowledged by our laws; giving his assent to their acts of " \
                   ...
                   "For suspending our own legislatures, and declaring themselves invested wit" \
                   ...
                   "dissolved; and that as free and independent states, they have full power to levy war, " \
